#!/usr/bin/env bash
# Publish a new Havemind plugin release to the Community catalogue distribution repo.
#
...
# version. Users update through the Obsidian Community directory.
#
...
echo "==> Done. Users can update from the Obsidian Community directory."
