...
- `specs/001-mvp.md`, product requirements (canonical, approved 2026-07-15).
- `plans/001-technical-plan.md`, architecture and engineering contract (canonical).
- `plans/004-006`, follow-up plans. 005 and 006 shipped; 004 (E2EE) is a design
  study, not scheduled.
...
Do not guess requirements or architecture. Everything is in `specs/` and `plans/`.
