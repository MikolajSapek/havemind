...
**Version 1.4.19, desktop and mobile.** A two-week pilot on two devices lost no
data, including through three real incidents. An empty phone join no longer
storms conflict copies.
